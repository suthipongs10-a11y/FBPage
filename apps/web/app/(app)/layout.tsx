...
const NAV: { key: MessageKey; href?: string }[] = [
  ...
  { key: 'nav.content', href: '/content' }, { key: 'nav.news', href: '/news' }, { key: 'nav.calendar', href: '/calendar' }, { key: 'nav.analytics', href: '/analytics' }, { key: 'nav.comments', href: '/comments' }, { key: 'nav.leads', href: '/leads' },
