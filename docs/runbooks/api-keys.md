> คู่มือขอคีย์เดิม: สำหรับรายการตั้งค่าและขั้นตอนตรวจครบทุกโมดูล รวม TikTok ให้ยึด [คู่มือรวมทุกโมดูล](../ALL_MODULES_CHECKLIST.md) เป็นหลัก การเปิดระบบบน Windows เครื่องนี้ใช้ scripts/local.ps1 ตาม LOCAL_SETUP ไม่ใช่คำสั่ง Docker ด้านล่าง
